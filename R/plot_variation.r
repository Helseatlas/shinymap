    ...
    the_plot <-
      ...
      ggplot2::aes(x = get("area_name"), y = get("value"), fill = get("brks"),
                   text = paste("<b>", get("area_name"), "</b><br>",
                                get("type"), ":", format(get("value"), big.mark = big_mark, decimal.mark = decimal_mark, digits = 2), "<br>",
                                get("numerator_name"), ":", format(get("numerator"), big.mark = big_mark, decimal.mark = decimal_mark, digits = 2)))) +
